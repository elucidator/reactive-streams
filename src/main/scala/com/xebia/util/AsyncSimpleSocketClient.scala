...
object AsyncSocketClientTester extends App {
  ...
  try {
    val to = 100000
    val tester = new AsyncSimpleSocketClient(port = 6000)
...
class AsyncSimpleSocketClient(val host: String = "localhost", val port: Int = 11111) {
